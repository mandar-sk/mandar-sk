...
- Currently pursuing a **Master’s in Data Science & Business Analytics at IISc Bangalore**.  
- Worked as a **Data Science Intern at Quantum Street AI** (an IBM-backed fintech), where I built **neural network models** for long-horizon stock return prediction and contributed to **financial forecasting and investment analytics**.  
- Previously worked at **Godrej & Boyce** in **quality assurance**, developing a foundation in **data analysis**, **process improvement**, and **decision support systems**.  

**Key Achievements:**  
- 2nd Runner-Up at **IISc’s Innovation Challenge**  
...
> **Quantum Street AI** `May’25 – Jul’25`  
> _Data Science Intern_

- Developed a deep learning–based multivariate time series forecasting pipeline to predict **1-month forward stock returns** of **mega-cap equities** using 200+ features spanning fundamental, technical, sentiment and macroeconomic factors.
- Designed a hybrid preprocessing workflow integrating **Wavelet Denoising, Stationarization,** & **PCA**, **reducing RMSE** by up to **76%** compared to raw inputs and revealing strong synergy between denoising and stationarization in enhancing signal quality.
- Implemented and evaluated multiple advanced architectures within the **Darts** framework, including **transformer-based (TiDE, TFT), convolution-based (TCN, DeepTCN), residual MLPs (N-BEATS, N-HiTS),** and **TSMixer**.
- Customized the **Extended LSTM (xLSTM)** architecture in **PyTorch**, scaling it down from a multi-billion–parameter design to a compact, efficient implementation for time series forecasting without compromising predictive performance.
- Achieved best results with **TiDE (RMSE = 1.63 %, R² = 0.94, directional accuracy = 96.97 %)**, while **xLSTM-TS** emerged as a strong contender with **directional accuracy = 98.52 %**.

> **Godrej & Boyce Mfg. Co. Ltd.** `Dec’20 – Oct’23`  
> _Assitant Manager Quality Assurance_

- Led a team of **4** engineers in **Quality Assurance** of 1,000+ SKUs, supplier quality control, and field complaint resolution.
- Applied **Six Sigma** and **Statistical Process Control** initiatives on **7** critical processes, improving stability and process capability.
- **Automated** Quality Control, reducing **product replacements** from **0.6%** to **0.33%** & **inhouse rejections** from **0.15%** to **0.06%**.

## Scholastic Achievements

> **InnovateX – IISc’s Innovation Challenge** `2025`

- Developed an **NLP-based** application that auto-categorizes bank transactions, eliminating the hassle of manual expense entry..

> **EY Techathon 5.0 – Technology Consulting Competition** `2024`

- Built **Laxmi-Sutra**, an AI-powered **investment guidance app** tailored for individuals with limited financial literacy. 
...
> **Regression Modeling and Statistical Inference on Clock Auction Price Determinants** 
> - Conducted exploratory and correlation analysis to study how clock age and number of bidders affect auction prices, using visualizations and statistical summaries in R.
> - Built and validated multiple regression models, checking significance through F-tests, t-tests, and confidence intervals, and compared partial vs. marginal correlations to interpret predictor importance.
> - Performed residual diagnostics and assumption tests (normality, homoscedasticity, multicollinearity), refined the model with an interaction term, and derived prediction intervals for practical insights.
> - GitHub repository: **https://github.com/mandar-sk/auction-price-regression-analysis**
...
> - Built a discrete-event simulation model of an (s, S) inventory system in Python (SimPy) and optimized policies to minimize long-run costs.
> - Applied statistical techniques (Welch’s method, replication/deletion, confidence intervals) for accurate steady-state analysis with visual insights (contour and 3D plots).
> - GitHub repository: **https://github.com/mandar-sk/Inventory_Model_with_Simpy**
...
> Technical: `Machine Learning`, `NLP`, `LLM`, `Statistical Modeling`, `Forecasting`, `Data Mining`, `Data Analysis`, `Data Visualization`, `Model Deployment`, `AWS (S3, EC2)`, `Finance`, `Economics`

> Interpersonal: `Strategy`, `Analytical Thinking`, `Problem Solving`, `Leadership`, `Communication`, `Teamwork`, `Presentation`

> Statistical Software: `Minitab`, `Stata`, `PowerBI`, `Excel`
